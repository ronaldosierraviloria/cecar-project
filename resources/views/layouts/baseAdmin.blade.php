...
<head>
    ...
    {{-- ── SEO ── --}}
    <title>@yield('title', 'Panel De Administrador') — Sistema de Grado CECAR</title>
    <meta name="application-name" content="Sistema de Grado CECAR">
    <meta name="description" content="@yield('meta_description', 'Panel de administración del Sistema de Gestión de Trabajos de Grado de CECAR. Gestión de trabajos, evaluadores, estudiantes y reportes.')">
    ...
    {{-- ── Font: Preconnect + Preload (.woff2 Latin subset) ── --}}
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    {{-- Preload the most-used weight (400) for fast LCP text render --}}
    <link rel="preload"
          as="font"
          type="font/woff2"
    ...
    <style>
        ...
        .active-link svg {
            color: var(--cecar-green);
        }

        .sidebar-link-inactive svg {
            color: var(--cecar-lime);
        }
...
<body class="bg-gray-100 font-poppins antialiased overflow-hidden">
    ...
    {{-- Progressive enhancement: browsers that don't support it will silently ignore --}}
