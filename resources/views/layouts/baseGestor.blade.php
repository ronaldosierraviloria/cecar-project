...
<head>
    ...
    {{-- ── SEO ── --}}
    <title>@yield('title', 'Panel del Gestor') — Sistema de Grado CECAR</title>
    <meta name="application-name" content="Sistema de Grado CECAR">
    <meta name="description" content="@yield('meta_description', 'Panel del Gestor del Sistema de Gestión de Trabajos de Grado de CECAR. Registro y administración de trabajos de grado.')">
...
<body class="bg-gray-100 font-poppins antialiased overflow-hidden">
    ...
    <div class="flex h-screen w-full overflow-hidden">
        ...
        {{-- SIDEBAR COMPONENT --}}
        @include('layouts.partials.gestorSidebar')
        ...
        <main id="app-main" class="flex-1 overflow-y-auto h-screen pb-20"
            ...
            {{-- HEADER COMPONENT --}}
            @include('layouts.partials.gestorHeader')
