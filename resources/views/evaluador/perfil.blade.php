...
@section('title', 'Mi Perfil | Evaluador')
@section('meta_description', 'Informacion del perfil del evaluador en el Sistema de Gestion de Trabajos de Grado de CECAR.')

@section('content')
@php
$roleDescription = 'Como Evaluador, tu función principal es la revisión y calificación de los trabajos de grado asignados.';
$roleTheme = ['bg' => 'from-slate-900 to-slate-700'];
@endphp
<div class="max-w-4xl mx-auto" x-data="{ showEditModal: false, loading: false }">
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('evaluador.dashboard') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm font-bold text-gray-600 hover:bg-gray-50 hover:text-[#07321e] transition-all shadow-sm">
                ...
                <div class="bg-white rounded-3xl border border-gray-100 flex flex-col justify-between overflow-hidden shadow-sm">
                    <div class="bg-gradient-to-r {{ $roleTheme['bg'] }} px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="text-base font-bold text-white">Rol del Evaluador</h3>
                        </div>
                    </div>
